...
describe Member do
  ...
  it "should calculate the acceptable risk amount" do
    member = Member.new :trading_capital => 10000, :risk_percentage => 2
    member.risk.should == (member.trading_capital * (member.risk_percentage.to_f / 100.0))
  end
