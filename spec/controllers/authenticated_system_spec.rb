...
describe SessionsController do
  ...
  describe "logout_killing_session!" do
    ...
    it 'forgets me' do    
      ...
      current_member.remember_token.should_not be_nil; current_member.remember_token_expires_at.should_not be_nil
      Member.find(1).remember_token.should_not be_nil; Member.find(1).remember_token_expires_at.should_not be_nil
      logout_killing_session!
      Member.find(1).remember_token.should     be_nil; Member.find(1).remember_token_expires_at.should     be_nil
    end
  end
